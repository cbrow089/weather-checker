...
*/
import { IWeather } from '../../server/src/service/types';
  
const renderCurrentWeather = (currentWeather: IWeather): void => {
  if (!currentWeather) {
    console.error('Current weather data is undefined');
    return; // Exit the function if currentWeather is undefined
  }
